...
MESSAGE_KEYS = [
    ...
    "control_session_plan_failed",
    "control_session_success",
    "control_session_failed",
    "control_session_safe_output_sent",
    "control_session_safe_output_absent",
    "control_session_axis_line",
    "control_session_first_failure_line",
    "control_session_final_mode_line",
    "control_session_audit_truncated",
    "control_session_audit_final_truncated",
    "control_session_runtime_failure_line",
    "control_session_runtime_failure_axis_line",
    "control_session_safeop_mode_line",
    ...
    "control_session_process_map_failed",
    "control_session_safe_op_not_reached",
    "control_session_dc_config_failed",
    "control_session_sync0_config_failed",
    "control_session_wkc_mismatch",
    "control_session_op_not_reached",
    "control_session_feedback_invalid",
    "control_session_controller_failed",
    "control_session_drive_fault",
    "control_session_internal_limit_active",
    ...
    "control_session_cycle_deadline_missed",
]

# 每条格式消息允许的 printf 转换说明符。资源文本可修改，参数契约不可漂移。
MESSAGE_FORMATS = {
    "control_session_final_mode_line": ("u", "s", "d", "s", "d"),
    "control_session_first_failure_line": ("u", "s", "s", "d"),
    "control_session_audit_truncated": ("u",),
    "control_session_audit_final_truncated": ("u",),
    "control_session_runtime_failure_line": ("u", "u", "s", "d", "u"),
    "control_session_runtime_failure_axis_line": ("u", "X", "X", "u", "s", "s"),
    "usage": ("s", "s", "s", "s", "s", "s"),
    ...
    "control_session_safe_output_sent": (),
    "control_session_safe_output_absent": (),
    "control_session_axis_line": ("u", "s", "s", "s", "s", "s", "s", "d", "d", "X", "X", "d", "d", "d", "s"),
    "control_session_safeop_mode_line": ("u", "s", "d", "X", "X", "X", "X", "s"),
